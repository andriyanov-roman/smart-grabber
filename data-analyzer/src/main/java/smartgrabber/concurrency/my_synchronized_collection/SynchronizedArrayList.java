        ...
        implements List<E>, RandomAccess, Cloneable, java.io.Serializable
{
     ...
     */
    public SynchronizedArrayList(Collection<? extends E> c) {
    ...
    private synchronized boolean batchRemove(Collection<?> c, boolean complement) {
    ...
    static final class ArrayListSpliterator<E> implements Spliterator<E> {
        ...
        ArrayListSpliterator(SynchronizedArrayList<E> list, int origin, int fence,
        ...
        public void forEachRemaining(Consumer<? super E> action) {
            ...
            SynchronizedArrayList<E> lst; Object[] a;
            if (action == null)
                throw new NullPointerException();
